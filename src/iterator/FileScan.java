 ...
 */
public class FileScan extends  Iterator implements Cloneable
{
  ...
  public  FileScan(FileScan fileScan) {
	  
	  _in1 = fileScan._in1;
	  in1_len = fileScan.in1_len;
	  s_sizes = fileScan.s_sizes; 
	  f = fileScan.f;
	  scan = fileScan.scan;
	  tuple1 = fileScan.tuple1;
	  Jtuple = fileScan.Jtuple;
	  t1_size = fileScan.t1_size;
	  nOutFlds = fileScan.nOutFlds;
	  OutputFilter = fileScan.OutputFilter;
	  perm_mat = fileScan.perm_mat;
	  
  }
  
  // This is for initialising the Loop joins because it seems we can't put the same FileScan... 
  // Maybe because of the Sort ? I was scared to change the Sort class I prefer to copy even if it's ugly that way
  public FileScan clone() throws CloneNotSupportedException {
		return (FileScan) super.clone();
	}
